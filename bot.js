...
if (message.content === ".help") {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(`:cyclone:  ${prefix}bc`, `:diamond_shape_with_a_dot_inside: لارسال راسألة جماعية لجميع اعضاء السيرفر :octagonal_sign:`)

      .addField(`:cyclone:  ${prefix}obc`, `:diamond_shape_with_a_dot_inside: لارسال رسالة جماعية للاون لاين فقط :diamond_shape_with_a_dot_inside:`)

      .addField(`:cyclone:  ${prefix}bot`, `:diamond_shape_with_a_dot_inside: لروياة معلومات البوت :diamond_shape_with_a_dot_inside:`)

      .addField(`:cyclone:  ${prefix}role-bc`, `:diamond_shape_with_a_dot_inside: لارسال رسالة لـ رول معين :diamond_shape_with_a_dot_inside:`)
	  
	  .setTitle(`:arrow_right: كرفريس ىلإ توبلا ةفاضإ ـل انه ظغضا :arrow_left: `)
...
msg.channel.sendEmbed(embed24)
   ...
   client.on('message', message => {
        ...
        .setTitle(`:octagonal_sign: كرفريس ىلإ توبلا ةفاضإ ـل انه ظغضا :octagonal_sign:  `)
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=449758849143013380&permissions=8&scope=bot`)
